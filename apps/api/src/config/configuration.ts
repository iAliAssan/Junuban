export interface AppConfig {
  ...
  sms: { provider: string; apiKey?: string; kavenegarTemplate?: string; ghasedakTemplate?: string };
  payment: {
    provider: string;
    merchantId?: string;
...
export default (): AppConfig => ({
  ...
  sms: {
    ...
    kavenegarTemplate: process.env.SMS_KAVENEGAR_TEMPLATE,
    ghasedakTemplate: process.env.SMS_GHASEDAK_TEMPLATE,
  },
  payment: {
