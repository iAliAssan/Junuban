...
export class CatalogService {
  ...
  async getCategoryBySlug(slug: string) {
    ...
    return {
      ...
      photo: category.photo ? { url: category.photo.url, altText: category.photo.altText } : null,
    ...
    return {
      ...
      producers: product.producers.map((pp) => ({
        ...
        producer: {
          ...
          photo: pp.producer.photo ? { url: pp.producer.photo.url, altText: pp.producer.photo.altText } : null,
        },
