...
import { IsEmail, IsIn, IsOptional, IsString, IsUUID, Matches, MaxLength, ValidateNested } from "class-validator";
...
export class CheckoutDto {
  ...
  @ApiPropertyOptional({
    description: "Customer-supplied note (delivery/packaging instructions, etc). Shown back to the customer and to admin; distinct from Order.notes (admin-internal only).",
  })
  @IsOptional()
  @IsString()
  @MaxLength(1000)
