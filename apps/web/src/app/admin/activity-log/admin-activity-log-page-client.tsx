...
const ACTION_LABELS: Record<string, string> = {
  ...
  "order.set_status": "تغییر وضعیت سفارش",
  ...
  "producer.create": "ایجاد تولیدکننده",
  "producer.update": "ویرایش تولیدکننده",
  "packaging_option.create": "ایجاد گزینه بسته‌بندی",
  "packaging_option.update": "ویرایش گزینه بسته‌بندی",
};
