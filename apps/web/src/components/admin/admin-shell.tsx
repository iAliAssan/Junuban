...
import { MenuIcon, CloseIcon, GridIcon, ClipboardListIcon, ActivityIcon, LogoutIcon } from "../ui/icons";
import { ADMIN_NAV_ITEMS } from "./admin-nav-items";
import styles from "./admin-shell.module.css";

const NAV_ICONS = { grid: GridIcon, clipboard: ClipboardListIcon, activity: ActivityIcon } as const;
