...
import { ProducerModal } from "@/components/producer-modal/producer-modal";
    ...
    <div className={styles.section}>
      {product.producers.length > 1 && (
        <fieldset className={styles.producerGroup}>
          <div className={styles.producerGroupHeader}>
            <legend className={styles.groupLabel}>انتخاب تولیدکننده</legend>
            <button type="button" className={styles.viewAllProducersLink} onClick={() => setProducerModalOpen(true)}>
