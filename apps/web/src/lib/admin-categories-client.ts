...
/** See admin-producers-client.ts's UpdateProducerPayload for why this isn't a plain Partial<>. */
export type UpdateCategoryPayload = Partial<Omit<CreateCategoryPayload, "photo">> & {
  photo?: { url: string; altText: string } | null;
};
